...
<section class="container w3-animate-zoom" align="center">
  			<h3><strong>These are the projects as well as codes available online ...<strong></h3>
  			<hr>
<%!
	...
	try{
		...
		while(resultSet.next()){
			i++;
		        ...
		        out.println("</div>");
		        		out.println("<h6 style='color: black'>HASH_CONTRIBUTOR : <span style='color: green'>" + hash + "</span></h6>");
		        		out.println("<h6 style='color: black'>PROBLEM SOLVED : <span style='color: red'>" + problemSolved + "</span></h6>");
